...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("月照云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.63.197"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25136;
pub const RELAY_PORT: i32 = 25137;
pub const WS_RENDEZVOUS_PORT: i32 =25138;
pub const WS_RELAY_PORT: i32 = 25139;
