...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.45.122.149"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 23536;
pub const RELAY_PORT: i32 = 23537;
pub const WS_RENDEZVOUS_PORT: i32 =23538;
pub const WS_RELAY_PORT: i32 = 23539;
