...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.197.34.162"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 22536;
pub const RELAY_PORT: i32 = 22537;
pub const WS_RENDEZVOUS_PORT: i32 =22538;
pub const WS_RELAY_PORT: i32 = 22539;
