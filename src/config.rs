...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("亿度通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.204.28.219"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 20736;
pub const RELAY_PORT: i32 = 20737;
pub const WS_RENDEZVOUS_PORT: i32 =20738;
pub const WS_RELAY_PORT: i32 = 20739;
