...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.63.19"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 21836;
pub const RELAY_PORT: i32 = 21837;
pub const WS_RENDEZVOUS_PORT: i32 =21838;
pub const WS_RELAY_PORT: i32 = 21839;
