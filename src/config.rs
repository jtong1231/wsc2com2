...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.197.63.26"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 24236;
pub const RELAY_PORT: i32 = 24237;
pub const WS_RENDEZVOUS_PORT: i32 =24238;
pub const WS_RELAY_PORT: i32 = 24239;
