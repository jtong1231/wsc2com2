...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.13.20"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 23936;
pub const RELAY_PORT: i32 = 23937;
pub const WS_RENDEZVOUS_PORT: i32 =23938;
pub const WS_RELAY_PORT: i32 = 23939;
