...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.10.43"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 20436;
pub const RELAY_PORT: i32 = 20437;
pub const WS_RENDEZVOUS_PORT: i32 =20438;
pub const WS_RELAY_PORT: i32 = 20439;
