...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("同行芸".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.45.122.147"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 23336;
pub const RELAY_PORT: i32 = 23337;
pub const WS_RENDEZVOUS_PORT: i32 =23338;
pub const WS_RELAY_PORT: i32 = 23339;
