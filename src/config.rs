...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("汇立宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.204.28.222"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 21136;
pub const RELAY_PORT: i32 = 21137;
pub const WS_RENDEZVOUS_PORT: i32 =21138;
pub const WS_RELAY_PORT: i32 = 21139;
