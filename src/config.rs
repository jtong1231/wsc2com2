...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("度义宝".to_owned());
...
pub const RENDEZVOUS_PORT: i32 = 20536;
pub const RELAY_PORT: i32 = 20537;
pub const WS_RENDEZVOUS_PORT: i32 =20538;
pub const WS_RELAY_PORT: i32 = 20539;
