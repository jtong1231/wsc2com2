...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.197.63.27"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 24836;
pub const RELAY_PORT: i32 = 24837;
pub const WS_RENDEZVOUS_PORT: i32 =24838;
pub const WS_RELAY_PORT: i32 = 24839;
