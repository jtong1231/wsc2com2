...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.197.63.29"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25036;
pub const RELAY_PORT: i32 = 25037;
pub const WS_RENDEZVOUS_PORT: i32 =25038;
pub const WS_RELAY_PORT: i32 = 25039;
